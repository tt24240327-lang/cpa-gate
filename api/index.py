...
KEYWORD_MAP = {
    # [???]
    "8cf12edf": "??????", "ca4a68a6": "????????, "c8a4cf5a": "??????", "d7ea613c": "?????,
    "cb845113": "??????",
    # [???]
    "faf45575": "???", "ce8a5ce4": "??????", "c8b22f8a": "??????", "d108d7a5": "????????,
    "f79702a3": "??????", "fa13bc33": "??????", "eeaf8186": "??????",
    # [???/???]
    "d0b65aba": "??????", "3e848ae6": "??????", "66cb8240": "??????",
    "8e2996c7": "??? ???", "81edc02c": "???????, "8745563e": "????????, "617a0005": "??????",
    "5d19986d": "??????????, "a0ef0c00": "????????", "e6d02452": "????????", "35467a5c": "????????",
    "9ce613e1": "?????????????, "68943f44": "???????? ???", "c8abc514": "??????? ??,
    # [???]
    "dc19f4ea": "???", "af5f2375": "??????", "c4c5ee7e": "??????", "4a2f6816": "??????",
    "87a3472b": "??????", "63b2da0a": "??????", "20186798": "?????????", "ef310430": "??? ??????",
    # [???/???]
    "ffbfdc28": "???????, "be4adb64": "??????", "a01f1db0": "???????, "b1585a85": "????????????",
    "c2bddbcc": "????? ???", "b6f6c35f": "???????, "3e750243": "??????",
    # [??? ?????
    "f2a3b4c5": "??????", "d1e2f3g4": "??????", "h5i6j7k8": "??????"
}
